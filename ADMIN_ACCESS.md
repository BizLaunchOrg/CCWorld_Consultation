...
6. Go to **https://www.ccworldconsulting.com/admin** (or `/admin`). You should see the admin dashboard. If not, you’ll be sent to `/admin/login` — sign in with the same account you made admin.
