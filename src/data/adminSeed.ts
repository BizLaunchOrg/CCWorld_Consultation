...
export const seedConsultations: AdminConsultation[] = [
  ...
  },
  {
    ...
    job_title: 'COO',
    service_selected: 'Licensing Advisory: PTSP',
    engagement_type: 'licensing_ptsp',
    license_type: 'ptsp',
    stage: 'pre_application',
    note: 'Exploring PTSP license. Need full scope and timeline. We have CAC and business plan ready.',
